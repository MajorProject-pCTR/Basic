...
int main(){
	...
	if(input_file.is_open() && output_file.is_open()){
		while(true){
			...
			output_file << y << " " << display_url << " " << ad_id << " " << advertiser_id << " " << depth << " " << position << " " << user_id << " " << desc_id << " " << desc_id_tokencnt << " " << titid << " " << titid_tokencnt << " " << purc_k_id_tokencnt << " " << qid << " " << qid_tokencnt << " " << user_id;
